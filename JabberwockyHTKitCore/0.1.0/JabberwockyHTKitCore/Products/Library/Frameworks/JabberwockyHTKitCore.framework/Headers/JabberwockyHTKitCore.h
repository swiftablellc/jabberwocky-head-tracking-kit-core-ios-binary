...
//! Project version number for JabberwockyHTKitCore.
FOUNDATION_EXPORT double JabberwockyHTKitCoreVersionNumber;

//! Project version string for JabberwockyHTKitCore.
FOUNDATION_EXPORT const unsigned char JabberwockyHTKitCoreVersionString[];

// In this header, you should import all the public headers of your framework using statements like #import <JabberwockyHTKitCore/PublicHeader.h>
